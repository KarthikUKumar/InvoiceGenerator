   ...
   <h4>Add Items</h4></center>
    ...
    <TABLE id="dataTable" class="table order-list">
        ...
        <TR>
            ...
            <td class="col-sm-4"><textarea row="5" cols="50" form="form1" name="desc[]" class="form-control"></textarea></td>
            <td class="col-sm-2"><input name="price[]" pattern="^\d*(\.\d{0,2})?$" form="form1" class="form-control">
            <TD class="col-sm-2">
    ...
    <INPUT type="button" value="Add Row +" onclick="addRow('dataTable')" class="btn btn-md btn btn-info col-sm-4">
    <INPUT type="button" value="Delete Row -" onclick="deleteRow('dataTable')" class="btn btn-md btn btn-danger col-sm-4">
    <input type="submit" value="Submit" class="btn btn-md btn btn-success col-sm-4">
</td>
</BODY>
</HTML>